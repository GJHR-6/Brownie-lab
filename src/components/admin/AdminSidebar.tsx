...
function NavIcon({ id }: { id: string }) {
  ...
  switch (id) {
    ...
    case "ic-wallet":    return <svg viewBox="0 0 24 24" {...S} className="w-[19px] h-[19px] flex-none"><rect x="3" y="6.5" width="18" height="13" rx="2.2"/><path d="M3 10h18"/><circle cx="16.5" cy="14.8" r="1.1" fill="currentColor" stroke="none"/></svg>;
    case "ic-coin":      return <svg viewBox="0 0 24 24" {...S} className="w-[19px] h-[19px] flex-none"><circle cx="12" cy="12" r="8.5"/><path d="M12 7.5v9M14.8 9.2c-.6-.9-1.6-1.4-2.8-1.4-1.7 0-3 1-3 2.2 0 2.8 6 1.4 6 4.2 0 1.2-1.3 2.2-3 2.2-1.2 0-2.2-.5-2.8-1.4"/></svg>;
    case "ic-truck":     return <svg viewBox="0 0 24 24" {...S} className="w-[19px] h-[19px] flex-none"><path d="M2.5 6.5h11.5v10H2.5zM14 9.5h4l3 3.2v3.8h-7z"/><circle cx="6.5" cy="18.2" r="1.7"/><circle cx="17.5" cy="18.2" r="1.7"/></svg>;
